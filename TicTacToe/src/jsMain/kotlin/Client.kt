...
val getElementByIdB1 = document.getElementById("b1").val getElementByIdB2 = document.getElementById("b2").toString()
val getElementByIdB3 = document.getElementById("b3").toString()
val getElementByIdB4 = document.getElementById("b4").toString()
val getElementByIdB5 = document.getElementById("b5").toString()
val getElementByIdB6 = document.getElementById("b6").toString()
val getElementByIdB7 = document.getElementById("b7").toString()
val getElementByIdB8 = document.getElementById("b8").toString()
val getElementByIdB9 = document.getElementById("b9").toString()

var b1 = getElementByIdB1
var b2 = getElementByIdB2
var b3 = getElementByIdB3
var b4 = getElementByIdB4
var b5 = getElementByIdB5
var b6 = getElementByIdB6
var b7 = getElementByIdB7
var b8 = getElementByIdB8
var b9 = getElementByIdB9
